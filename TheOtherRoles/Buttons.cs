...
internal static class HudManagerStartPatch
{
    ...
    public static void createButtonsPostfix(HudManager __instance)
    {
        ...
        engineerRepairButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Engineer) &&
                       Engineer.local.remainingFixes > 0 && !PlayerControl.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        janitorCleanButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Janitor) &&
        ...
        sheriffKillButton = new CustomButton(
            ...
            () => { sheriffKillButton.Timer = sheriffKillButton.MaxTimer; },
            Helpers.loadSpriteFromResources("TheOtherRoles.Resources.SheriffKillButton.png", 100f),
            CustomButton.ButtonPositions.upperRowRight,
            __instance,
            KeyCode.Q,
        ...
        medicShieldButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Medic) &&
                       !PlayerControl.LocalPlayer.Data.IsDead;
            },
        ...
        hackerButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Hacker) &&
                       !PlayerControl.LocalPlayer.Data.IsDead;
            },
            () => { return true; },
            () =>
            ...
            () =>
            {
                if (GameOptionsManager.Instance.currentNormalGameOptions.MapId != 1)
                {
                    if (Hacker.local.vitals == null)
                    {
                        ...
                        Hacker.local.vitals = Object.Instantiate(e.MinigamePrefab, Camera.main.transform, false);
                    }
                ...
                else
                {
                    if (Hacker.local.doorLog == null)
                    {
                        ...
                        if (e == null || Camera.main == null) return;
                        Hacker.local.doorLog = Object.Instantiate(e.MinigamePrefab, Camera.main.transform, false);
                    }
        ...
        portalmakerPlacePortalButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Portalmaker) &&
        ...
        usePortalButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.CanMove &&
                       (Portal.locationNearEntry(PlayerControl.LocalPlayer.transform.position) ||
                        (Portalmaker.canPortalFromAnywhere && PlayerControl.LocalPlayer.isRole(RoleId.Portalmaker))) &&
        ...
        portalmakerMoveToPortalButton = new CustomButton(
            ...
            () =>
            {
                return Portalmaker.canPortalFromAnywhere && Portal.bothPlacedAndEnabled &&
                       PlayerControl.LocalPlayer.isRole(RoleId.Portalmaker);
            },
            () =>
            {
                return PlayerControl.LocalPlayer.CanMove &&
        ...
        mediumButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Medium) &&
                       !PlayerControl.LocalPlayer.Data.IsDead;
            },
            () =>
            {
            ...
            () =>
            {
                ...
                var msg = Medium.getInfo(Medium.local.target.player, Medium.local.target.killerIfExisting,
                    Medium.local.target.deathReason);
                ...
                if (Medium.oneTimeUse)
                {
                    ...
                    foreach (var (db, ps) in Medium.local.deadBodies)
                    ...
                    foreach (var rend in Medium.local.souls)
                    {
        ...
        mayorMeetingButton = new CustomButton(
            ...
            () =>
            {
                return PlayerControl.LocalPlayer.isRole(RoleId.Mayor) &&
        ...
        yoyoButton = new CustomButton(
            ...
            () =>
            {
                ...
                var exit = (Vector3)Yoyo.markedLocation;
                if (SubmergedCompatibility.IsSubmerged) SubmergedCompatibility.ChangeFloor(exit.y > -7);
                var writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.YoyoBlink, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)0);
                writer.WriteBytesAndSize(buff);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
