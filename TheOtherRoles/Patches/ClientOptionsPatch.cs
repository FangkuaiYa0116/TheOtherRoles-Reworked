...
public static class ClientOptionsPatch
{
    private static readonly SelectionBehaviour[] AllOptions =
    {
        ...
        new("enbaleDarkMode",
            () => TORMapOptions.enableDarkMode = TheOtherRolesPlugin.EnableDarkMode.Value =
                !TheOtherRolesPlugin.EnableDarkMode.Value, TheOtherRolesPlugin.EnableDarkMode.Value)
    };
